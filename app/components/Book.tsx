      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12 lg:gap-16 items-start">
        <Reveal className="lg:sticky lg:top-28">
          ...
          <a
            ...
            className="mt-8 inline-flex items-center gap-3 rounded-full bg-[image:var(--btn-ink)] text-[var(--blush)] pl-5 pr-6 py-3.5 hover:-translate-y-0.5 hover:shadow-[0_10px_24px_-8px_color-mix(in_srgb,var(--hero-shade)_40%,transparent)] active:scale-[0.98] transition-[transform,box-shadow] duration-200"
          >
