        ...
        <Reveal delay={120}>
          <dl className="flex flex-col gap-3">
            {copy.items.map(([label, value], index) => (
              <div
                key={label}
                className="grid grid-cols-[2.5rem_1fr] sm:grid-cols-[3.25rem_0.9fr_1.1fr] gap-x-4 md:gap-x-8 rounded-2xl bg-[var(--stone-deep)] shadow-[var(--shadow-panel)] px-5 md:px-7 py-5 md:py-6"
              >
