...
export const copies: Record<Locale, SiteCopy> = {
  it: {
    ...
    form: { sent: "Richiesta inviata.", sentText: "Ti risponderemo al più presto con la disponibilità richiesta.", dateError: "La data di partenza deve essere dopo l'arrivo.", name: "Nome e cognome *", email: "Email *", phone: "Telefono", guests: "Numero ospiti", suite: "Suite di interesse", undecided: "Non so ancora", arrival: "Arrivo", departure: "Partenza", message: "Messaggio", placeholder: "Preferenze, orario di arrivo o altre richieste.", privacyConsent: "Ho letto l’informativa privacy e acconsento all’invio dei dati per ricevere risposta alla richiesta.", privacyLink: "Leggi l’informativa privacy", sendError: "Invio non riuscito. Riprova oppure scrivi a", sending: "Invio in corso...", send: "Invia richiesta" },
  ...
  en: {
    ...
    form: { sent: "Request sent.", sentText: "We will be in touch shortly with the requested availability.", dateError: "Departure must be after arrival.", name: "Full name *", email: "Email *", phone: "Phone", guests: "Number of guests", suite: "Preferred suite", undecided: "Not sure yet", arrival: "Arrival", departure: "Departure", message: "Message", placeholder: "Preferences, arrival time or other requests.", privacyConsent: "I have read the privacy notice and agree to send my details in order to receive a reply.", privacyLink: "Read the privacy notice", sendError: "We could not send your request. Please try again or email", sending: "Sending...", send: "Send request" },
  ...
  es: {
    ...
    form: { sent: "Solicitud enviada.", sentText: "Te responderemos pronto con la disponibilidad solicitada.", dateError: "La fecha de salida debe ser posterior a la llegada.", name: "Nombre y apellidos *", email: "Correo electrónico *", phone: "Teléfono", guests: "Número de huéspedes", suite: "Suite preferida", undecided: "Aún no lo sé", arrival: "Llegada", departure: "Salida", message: "Mensaje", placeholder: "Preferencias, hora de llegada u otras solicitudes.", privacyConsent: "He leído la política de privacidad y acepto enviar mis datos para recibir una respuesta.", privacyLink: "Leer la política de privacidad", sendError: "No se pudo enviar. Inténtalo de nuevo o escribe a", sending: "Enviando...", send: "Enviar solicitud" },
