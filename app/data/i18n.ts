...
export const copies: Record<Locale, SiteCopy> = {
  it: {
    ...
    story: { eyebrow: "La Dimora", title: ["Dell’Ottocento,", "aperta al presente."], paragraphs: ["Palazzo Vite è una dimora storica ottocentesca nel centro storico di Copertino, appena fuori le mura del Castello Angioino. La scala in pietra, la balaustra in ferro battuto e il soffitto decorato conservano il carattere originario del palazzo. Poco distante, il castello è un rilevante esempio di architettura militare rinascimentale in Puglia.", "Il restauro mette in dialogo questa architettura con un'accoglienza contemporanea. Mobili antichi recuperati, pezzi di design e opere d'arte compongono ambienti riservati, curati senza perdere la loro naturalezza."], details: [["Origine", "Dimora ottocentesca"], ["Carattere", "Arredi restaurati e design"], ["Posizione", "Fuori le mura del Castello"]], imageAlt: "Soffitto decorato sopra la scala originale di Palazzo Vite, dimora storica a Copertino", detailImageAlt: "Dettaglio architettonico di Palazzo Vite" },
