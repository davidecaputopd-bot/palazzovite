...
export const copies: Record<Locale, SiteCopy> = {
  it: {
    ...
    rooms: { eyebrow: "Le Suite", title: ["Cinque suite,", "cinque elementi."], doubleBed: "Letto matrimoniale", twinBeds: "Due letti singoli", bathroom: "Bagno", privateBathroom: "Bagno privato", wifi: "Wi-Fi", photoSoon: "Foto in arrivo", request: "Richiedi per questa suite →", bathroomImageAlt: "Bagno della suite", descriptions: roomDescriptions.it },
    ...
    book: { title: "Richiedi disponibilità.", description: "Inserisci date, numero di ospiti e suite preferita: ti risponderemo con una proposta chiara e completa.", directBooking: "Oppure prenota direttamente su Booking.com", writeTo: "oppure scrivi direttamente a" },
    form: { sent: "Richiesta inviata.", sentText: "Abbiamo ricevuto date e preferenze. Ti risponderemo al più presto con la disponibilità.", dateError: "La data di partenza deve essere dopo l'arrivo.", name: "Nome e cognome *", email: "Email *", phone: "Telefono", guests: "Numero ospiti *", suite: "Suite di interesse", undecided: "Non so ancora", arrival: "Arrivo *", departure: "Partenza *", requiredFields: "I campi contrassegnati con * sono necessari per verificare la disponibilità.", message: "Messaggio", placeholder: "Preferenze, orario di arrivo o altre richieste.", privacyConsent: "Dichiaro di aver preso visione dell’informativa privacy per l’invio della richiesta.", privacyLink: "Leggi l’informativa privacy", sendError: "Invio non riuscito. Riprova oppure scrivi a", sending: "Invio in corso...", send: "Invia richiesta" },
  ...
  en: {
    ...
    rooms: { eyebrow: "The Suites", title: ["Five suites,", "five elements."], doubleBed: "Double bed", twinBeds: "Two single beds", bathroom: "Bathroom", privateBathroom: "Private bathroom", wifi: "Wi-Fi", photoSoon: "Photos coming soon", request: "Enquire about this suite →", bathroomImageAlt: "Bathroom in the", descriptions: roomDescriptions.en },
    ...
    book: { title: "Check availability.", description: "Send your dates, number of guests and preferred suite: we will reply with a clear proposal.", directBooking: "Or book directly on Booking.com", writeTo: "or email us directly at" },
    form: { sent: "Request sent.", sentText: "We have received your dates and preferences. We will reply shortly with availability.", dateError: "Departure must be after arrival.", name: "Full name *", email: "Email *", phone: "Phone", guests: "Number of guests *", suite: "Preferred suite", undecided: "Not sure yet", arrival: "Arrival *", departure: "Departure *", requiredFields: "Fields marked with * are required to check availability.", message: "Message", placeholder: "Preferences, arrival time or other requests.", privacyConsent: "I confirm that I have read the privacy notice before sending this request.", privacyLink: "Read the privacy notice", sendError: "We could not send your request. Please try again or email", sending: "Sending...", send: "Send request" },
  ...
  fr: {
    ...
    rooms: { eyebrow: "Les Suites", title: ["Cinq suites,", "cinq éléments."], doubleBed: "Lit double", twinBeds: "Deux lits simples", bathroom: "Salle de bains", privateBathroom: "Salle de bains privée", wifi: "Wi-Fi", photoSoon: "Photos à venir", request: "Demander cette suite →", bathroomImageAlt: "Salle de bains de la suite", descriptions: roomDescriptions.fr },
    ...
    book: { title: "Vérifier les disponibilités.", description: "Indiquez vos dates, le nombre de personnes et la suite souhaitée : nous vous répondrons avec une proposition claire.", directBooking: "Ou réserver directement sur Booking.com", writeTo: "ou écrivez-nous à" },
    form: { sent: "Demande envoyée.", sentText: "Nous avons reçu vos dates et préférences. Nous vous répondrons rapidement avec les disponibilités.", dateError: "La date de départ doit être postérieure à l'arrivée.", name: "Nom et prénom *", email: "E-mail *", phone: "Téléphone", guests: "Nombre de personnes *", suite: "Suite souhaitée", undecided: "Je ne sais pas encore", arrival: "Arrivée *", departure: "Départ *", requiredFields: "Les champs marqués d’un * sont nécessaires pour vérifier les disponibilités.", message: "Message", placeholder: "Préférences, heure d'arrivée ou autre demande.", privacyConsent: "Je confirme avoir pris connaissance de la notice de confidentialité avant l’envoi de cette demande.", privacyLink: "Lire la notice de confidentialité", sendError: "L'envoi a échoué. Réessayez ou écrivez à", sending: "Envoi en cours...", send: "Envoyer la demande" },
  ...
  es: {
    ...
    rooms: { eyebrow: "Las Suites", title: ["Cinco suites,", "cinco elementos."], doubleBed: "Cama doble", twinBeds: "Dos camas individuales", bathroom: "Baño", privateBathroom: "Baño privado", wifi: "Wi-Fi", photoSoon: "Fotos próximamente", request: "Consultar esta suite →", bathroomImageAlt: "Baño de la suite", descriptions: roomDescriptions.es },
    ...
    book: { title: "Consultar disponibilidad.", description: "Indícanos las fechas, el número de huéspedes y la suite preferida: te responderemos con una propuesta clara.", directBooking: "O reserva directamente en Booking.com", writeTo: "o escríbenos a" },
    form: { sent: "Solicitud enviada.", sentText: "Hemos recibido tus fechas y preferencias. Te responderemos pronto con la disponibilidad.", dateError: "La fecha de salida debe ser posterior a la llegada.", name: "Nombre y apellidos *", email: "Correo electrónico *", phone: "Teléfono", guests: "Número de huéspedes *", suite: "Suite preferida", undecided: "Aún no lo sé", arrival: "Llegada *", departure: "Salida *", requiredFields: "Los campos marcados con * son necesarios para comprobar la disponibilidad.", message: "Mensaje", placeholder: "Preferencias, hora de llegada u otras solicitudes.", privacyConsent: "Declaro haber leído la política de privacidad antes de enviar esta solicitud.", privacyLink: "Leer la política de privacidad", sendError: "No se pudo enviar. Inténtalo de nuevo o escribe a", sending: "Enviando...", send: "Enviar solicitud" },
