...
export const copies: Record<Locale, SiteCopy> = {
  it: {
    ...
    spaces: { title: "Gli spazi comuni.", intro: "Palazzo Vite è pensato per alternare la riservatezza delle suite a luoghi condivisi, curati e semplici da vivere durante il soggiorno.", garden: ["Il Giardino", "Un giardino attrezzato tra agrumi e spazi verdi, per la colazione, un aperitivo o una pausa all'aperto."], breakfast: ["Sala e cucina", "La sala colazioni e l'angolo cottura in comune offrono uno spazio raccolto per iniziare la giornata o preparare qualcosa con calma."], work: ["Work room", "Una stanza tranquilla per leggere, lavorare o organizzare le tappe del viaggio nel Salento."], terrace: ["La Terrazza", "Una terrazza attrezzata tra le bouganville, con vista sul Castello Angioino e sui tetti del centro storico."], galleryLabel: "Sfoglia gli ambienti", categories: { staircase: "La scala a chiocciola", lounge: "Il salone", reading: "La sala lettura", kitchen: "La cucina", terrace: "La terrazza", garden: "Il giardino" } },
  ...
  en: {
    ...
    spaces: { title: "Shared spaces.", intro: "Palazzo Vite balances the privacy of its suites with shared areas that are considered, quiet and easy to inhabit throughout the stay.", garden: ["The Garden", "A furnished garden among citrus trees and greenery, arranged for breakfast, an aperitivo or a quiet pause outdoors."], breakfast: ["Breakfast room", "The breakfast room and shared kitchenette offer an intimate place to start the day or prepare something at an unhurried pace."], work: ["Work room", "A quiet room for reading, working or planning the next stages of a journey through Salento."], terrace: ["The Terrace", "A furnished terrace framed by bougainvillea, overlooking the Angevin Castle and the rooftops of the old town."], galleryLabel: "Browse the spaces", categories: { staircase: "The spiral staircase", lounge: "The lounge", reading: "The reading room", kitchen: "The kitchen", terrace: "The terrace", garden: "The garden" } },
  ...
  fr: {
    ...
    spaces: { title: "Les espaces communs.", intro: "Palazzo Vite associe l'intimité des suites à des espaces partagés, soignés et faciles à vivre tout au long du séjour.", garden: ["Le Jardin", "Un jardin aménagé parmi les agrumes et la verdure, pour le petit-déjeuner, un apéritif ou une pause en plein air."], breakfast: ["Salle et kitchenette", "La salle du petit-déjeuner et la kitchenette commune offrent un lieu intime pour commencer la journée ou préparer quelque chose tranquillement."], work: ["Work room", "Une pièce calme pour lire, travailler ou organiser les étapes d'un voyage dans le Salento."], terrace: ["La Terrasse", "Une terrasse aménagée parmi les bougainvilliers, avec vue sur le château angevin et les toits du centre ancien."], galleryLabel: "Parcourir les espaces", categories: { staircase: "L'escalier en colimaçon", lounge: "Le salon", reading: "La salle de lecture", kitchen: "La cuisine", terrace: "La terrasse", garden: "Le jardin" } },
  ...
  es: {
    ...
    spaces: { title: "Los espacios comunes.", intro: "Palazzo Vite combina la privacidad de sus suites con zonas compartidas cuidadas, tranquilas y fáciles de vivir durante la estancia.", garden: ["El Jardín", "Un jardín acondicionado entre cítricos y zonas verdes, para desayunar, tomar un aperitivo o descansar al aire libre."], breakfast: ["Sala y cocina", "La sala de desayunos y la pequeña cocina compartida ofrecen un lugar íntimo para empezar el día o preparar algo con calma."], work: ["Work room", "Una estancia tranquila para leer, trabajar u organizar las etapas de un viaje por el Salento."], terrace: ["La Terraza", "Una terraza equipada entre buganvillas, con vistas al Castillo Angevino y a los tejados del centro histórico."], galleryLabel: "Recorre los espacios", categories: { staircase: "La escalera de caracol", lounge: "El salón", reading: "La sala de lectura", kitchen: "La cocina", terrace: "La terraza", garden: "El jardín" } },
